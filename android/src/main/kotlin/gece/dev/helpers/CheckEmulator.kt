...
class CheckEmulator {
    ...
    private val knownEmulatorBuildProps = listOf(
        ...
        "QC_Reference_Phone" == Build.BOARD && !Build.MANUFACTURER.equals(
            "xiaomi",
            ignoreCase = true
        ),
    ...
    fun isEmulator(): Boolean {
        return knownEmulatorBuildProps.any { it } || SystemProperties.get("ro.kernel.qemu") == "1" || checkEmulatorFiles()
    }
    ...
    private fun checkEmulatorFiles(): Boolean {
        return checkFiles(GENY_FILES) || checkFiles(ANDY_FILES) || checkFiles(NOX_FILES) || checkFiles(
            X86_FILES
        ) || checkFiles(PIPES)
    }
}